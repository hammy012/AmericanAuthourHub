            ...
            <form method="POST" action="{{ route('admin.faq-update', $faq->id) }}">
                ...
                <div class="row">
                    {{--  <div class="col-md-12 mb-3">
                        <label>Topic</label>
                        <input type="text" name="topic" class="form-control" value="{{ old('topic', $faq->topic) }}">
                    </div>  --}}
                    ...
                    <div class="col-md-12 mb-3">
                        <label>Answer</label>
                        <textarea name="answer" class="form-control tinymce" rows="6">{{ old('answer', $faq->answer) }}</textarea>
                    </div>
